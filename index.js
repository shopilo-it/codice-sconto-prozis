 ...
 * Homepage: https://shopilo.it/negozi/prozis.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/prozis.com";
const STORE_NAME  = "Prozis";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-prozis)" }
  });
