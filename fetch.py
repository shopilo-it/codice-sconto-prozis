#!/usr/bin/env python3
"""
Recupero codici sconto Prozis da shopilo.it
Sursa: https://shopilo.it/negozi/prozis.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/prozis.com"
STORE_NAME = "Prozis"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Prozis da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-prozis)"
    }
    try:
